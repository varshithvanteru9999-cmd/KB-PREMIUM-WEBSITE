-- MySQL Industry-Grade Salon System Database Schema (Final Complete Version)
...
-- 3. Resources (Physical assets/chairs/stations)
CREATE TABLE resources (
    resource_id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(100) NOT NULL,
    type VARCHAR(50) NOT NULL, -- hair_chair | facial_bed | massage_chair | pedicure_seat | general
...
-- Settings
INSERT INTO settings (`key`, `value`) VALUES ('slot_interval',      '15');
INSERT INTO settings (`key`, `value`) VALUES ('max_advance_days',   '30');
INSERT INTO settings (`key`, `value`) VALUES ('walkin_reserve_pct', '0');
